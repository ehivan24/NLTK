...
#tokenizing -words, sentences, separates by
#lexicon and corporas
#corporas = body of text
#lexicon = dictionary and meanings
...
example_sentence = 'This is showing off stop words filtration'
...
exampleArray = ['The incredible intimidating NLP scares people away who are sissies']
...
def processLenguage():
    try:
        ...
        for item in contentArray:
            ...
            eliminates tags in the array }<<RB|NNS>>{ 
            chunkGram = r""" 
            ...
            chunked.draw()# visualize the data
            '''
